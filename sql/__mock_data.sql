...
INSERT INTO users (id, email, password, role, name, phone_number, bio, organization_id, language, timezone) VALUES
                                                                                                                (1, 'admin@naturex.example', 'pw_hash_admin_01', 'ADMIN', '김관리', '010-1000-0001', '시스템 관리자', 1, 'ko', 'Asia/Seoul'),
                                                                                                                (2, 'pm@naturex.example', 'pw_hash_user_02', 'USER', '이프로', '010-1000-0002', '프로젝트 매니저', 1, 'ko', 'Asia/Seoul'),
                                                                                                                (3, 'analyst@urbanpulse.example', 'pw_hash_user_03', 'USER', '박분석', '010-1000-0003', '데이터 분석 담당', 7, 'ko', 'Asia/Seoul'),
                                                                                                                (4, 'field@ecoparkfac.example', 'pw_hash_user_04', 'USER', '최현장', '010-1000-0004', '현장 운영 담당', 5, 'ko', 'Asia/Seoul'),
                                                                                                                (5, 'ops@blueriver.go.kr', 'pw_hash_user_05', 'USER', '정운영', '010-1000-0005', '지자체 시설 운영', 2, 'ko', 'Asia/Seoul'),
                                                                                                                (6, 'planner@blueriver.go.kr', 'pw_hash_user_06', 'USER', '윤기획', '010-1000-0006', '정책/기획', 2, 'ko', 'Asia/Seoul'),
                                                                                                                (7, 'researcher@sri.example', 'pw_hash_user_07', 'USER', '오연구', '010-1000-0007', '연구 담당', 6, 'en', 'Asia/Seoul'),
                                                                                                                (8, 'bd@mbdc.example', 'pw_hash_user_08', 'USER', '한생태', '010-1000-0008', '생물다양성 센터', 8, 'ko', 'Asia/Seoul'),
                                                                                                                (9, 'volunteer@greensteps.org', 'pw_hash_user_09', 'USER', '서봉사', '010-1000-0009', 'NGO 자원봉사자', 3, 'ko', 'Asia/Seoul'),
                                                                                                                (10, 'lead@greensteps.org', 'pw_hash_user_10', 'USER', '문리드', '010-1000-0010', '캠페인 리드', 3, 'en', 'Asia/Seoul'),
                                                                                                                (11, 'asset@haneulam.example', 'pw_hash_user_11', 'USER', '배자산', '010-1000-0011', '자산 가치 개선 담당', 4, 'ko', 'Asia/Seoul'),
                                                                                                                (12, 'consultant@solo.example', 'pw_hash_user_12', 'USER', '장컨설턴트', '010-1000-0012', '1인 컨설팅', 9, 'ko', 'Asia/Seoul'),
                                                                                                                (13, 'qa@naturex.example', 'pw_hash_user_13', 'USER', '고테스트', '010-1000-0013', '품질/검증', 1, 'ko', 'Asia/Seoul'),
                                                                                                                (14, 'support@urbanpulse.example', 'pw_hash_user_14', 'USER', '신지원', '010-1000-0014', '고객 지원', 7, 'ko', 'Asia/Seoul'),
                                                                                                                (15, 'archived@archived-demo.example', 'pw_hash_user_15', 'USER', '폐기계정', '010-1000-0015', '아카이브 조직 사용자', 10, 'ko', 'Asia/Seoul');
